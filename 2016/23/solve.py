raw_lines = open("input2.txt", "r").read()
        ...
        if a == "cpy":
            ...
            if b in regs:
                ...
                if (
                    pc + 3 < len(lines)
                    and pc - 1 >= 0
                    and lines[pc - 1].startswith("cpy ")
                    and lines[pc + 1].startswith("dec")
                    and lines[pc + 2].startswith("jnz")
                    and lines[pc + 3].startswith("dec")
                    and lines[pc + 4].startswith("jnz")
                ):
